...
function WalletComponent() {
  ...
  return (
    <div className="flex justify-around items-center h-[100%] lg:flex-row flex-col sm:flex-row backdrop-blur-3xl sm:backdrop-blur-3xl ">
      <div className="metamask flex flex-col items-center w-[80%] h-[25%] sm:w-[25vw] sm:h-[50%]">
        <div
      ...
      <div className="walletConnect w-[80%] h-[25%] flex flex-col items-center w-[80%] h-[25%] sm:w-[25vw] sm:h-[55%]">
        <div
      ...
      <div className="coinbase w-[80%] h-[25%] flex flex-col items-center w-[80%] h-[25%] sm:w-[25vw] sm:h-[55%]">
        <div
